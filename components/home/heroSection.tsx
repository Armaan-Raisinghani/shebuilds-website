      ...
      <div className="flex flex-col items-center gap-3 w-full -translate-y-4 animate-fade-in opacity-0 [--animation-delay:0ms]">
        <div className="flex flex-col items-center gap-4 sm:gap-5 w-full">
          <div className="flex flex-col items-center gap-3 sm:gap-4 w-full">
            <div className="flex flex-col items-center gap-2 sm:flex-row sm:gap-2.5 px-4 sm:px-12 py-0.5 rounded-full">
              <div className="inline-flex items-center gap-2">
                ...
                <div className="flex flex-col w-32 sm:w-46 items-start">
                  <Image
          ...
          <p className="w-full max-w-xl font-montserrat font-normal text-gray-900 text-sm sm:text-base text-center tracking-normal leading-relaxed -translate-y-4 animate-fade-in opacity-0 [--animation-delay:400ms]">
            SheBuilds AI spotlights leaders and innovators, surfaces insights and trends, and expands access to opportunities, scholarships, and resources. The goal is to inspire, enable, and strengthen India&apos;s women-in-tech movement.
          </p>
        </div>
      </div>
